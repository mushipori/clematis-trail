...
public static class Constants
{
	...
	public const string MENU_TOGGLE_INPUT = "menu_toggle";
	public const string SELECT_INPUT = "select";
	...
	public const string UI_ACCEPT_INPUT = "ui_accept";
	public const string UI_CANCEL_INPUT = "ui_cancel";
